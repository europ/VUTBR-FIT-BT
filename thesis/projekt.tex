...
%\documentclass[english, twoside]{fitthesis} % OBOJSTRANNE
%\documentclass[english]{fitthesis} % JEDNOSTRANNE
...
\projectinfo{
  ...
  date=16.05.2018,           %datum odevzdani / submission date
  %Nazev prace / thesis title
  title.cs={Průběžná integrace a automatizovaná kontrola kódu v projektech s otevřeným zdrojovým kódem},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Continuous Integration and Automated Code Review in Open Source Projects}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Adrián Tóth},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={Adrián},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={Tóth},   %prijmeni autora (pro citaci) / author surname (for reference) 
...
\abstract[en]{{\color{red}\textbf{TODO}}}

%Klicova slova (cesky, slovensky ci anglicky) / Keywords (in czech, slovak or english)
\keywords[cs]{průběžná integrace, build skript, automatizovaná kontrola kódu, ManageIQ, bot, Ruby}
\keywords[en]{continuous integration, build script, automated code review, ManageIQ, bot, Ruby}
