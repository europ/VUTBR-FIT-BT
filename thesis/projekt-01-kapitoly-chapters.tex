...
In these days, Continuous Integration (CI) is more often used in larger projects, where are multiple developers working on the same one software product. This process ensure fast developement, called eXtreme Programming (XP), known as agile software developement methodology. The methodology is mainly used for the speed of the developement nevertheless many disruptions may be fetched in the developing software. The developement process requires many code checking tools after every single code change in the source code of the software. Forasmuch as with every signle change of code, there is a possibility to add, fix, derange or deteriorate any parts of the software product. These tools provide an automated code review and they afford a quick feedback to the developer, who has made the change in the code, about his adjustment. The automated process which provides the code review do not bother without executing a huge amount of tests. Above mentioned process is conducted via CI server, also called as \uv{bot}. This \uv{bot} is invoked every time after any change in the source code and he had to execute the stated acts which are predefined.\\
This thesis attempts to explain how the fundamentals of continuous integration and automated code review work. It describes how it is integrated to the software developement, and how it works on an extensive project nowadays. Examples will be based on open-source project - ManageIQ, which is a cloud manager founded by RedHat. The developing process of the ManageIQ rests in agile and stable progress of developement. These main factors of the developement process could not be reached without a quick feedback about the changes, that are submitted to the software.

\section{Software Engineering \& Software Developement}
Beforehand we describe how does the continuous integration work and how, we could reveal what is software engineering and software developement, in which is continuous integration used. ...\\
TODO: def. or descr.: SW product, methodology

\section{Continuous Integration}
Continuous integration has a key role in the software developement process consisting of few certain unavoidable steps. Everything begins in the moment, when one developer, who has made changes in the source code of the software product is trying to commit them into the software product. The process of continuous integration has begun at this point. ...
