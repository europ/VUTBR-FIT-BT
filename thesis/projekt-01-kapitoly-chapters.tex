...
An overall summary of the implemented enhancements to the ManageIQ bot was provided by the bot maintainer Jason Fray - principal architect of the ManageIQ project, where are in detail described the pros and cons of each added enhancement.
