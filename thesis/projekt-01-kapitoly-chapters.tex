...
{\color{red}\textbf{`make normostrany` fails here, the code above contains \$ which stops the detex at this point, the text behind the \$ is ignored to the end}}\\
