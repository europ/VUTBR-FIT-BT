...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{img/review.eps}
    \caption{{\color{red}TODO\{redraw it, bad quality\}} Workflow of code review.}
    \label{fig:review_process}
\end{figure}

{\color{red}TODO\{process description\}}
